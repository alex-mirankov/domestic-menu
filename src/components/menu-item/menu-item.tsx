...
import {Category, Difficulty, DIFFICULTY_MAP, IMenuItem, PRICE_MAP, Season} from "../../models/menu-item.interface";
...
function MenuItem({ id, img, difficulty, name, preparationTime, price, season, ingredients }: IMenuItem) {
    const mapDifficulty = (item: string | Difficulty | Category | Season, hash: Map<string, IColoredLabel>): IColoredLabel => {
    ...
    return (
        <div id={id} className="menu-item">
            ...
            <div className="menu-item__info">
                ...
                <p>Сложность: <ColoredLabel { ...mapDifficulty(difficulty, DIFFICULTY_MAP) } /></p>
                <p>Время готовки: <ColoredLabel {...mapPreparationTime(preparationTime)} /></p>
                <p>Цена: <ColoredLabel { ...mapDifficulty(price, PRICE_MAP) } /></p>
